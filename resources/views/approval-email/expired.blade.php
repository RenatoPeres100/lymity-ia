...
<title>Link expirado — Lymity IA</title>
<style>
...
<div class="card">
  ...
  <p class="sub">{{ $message ?? 'Este link não é mais válido. Acesse o painel da Lymity IA para executar a ação.' }}</p>
  <a href="{{ config('app.url') }}" class="btn">Acessar o painel</a>
</div>
</body>
</html>
