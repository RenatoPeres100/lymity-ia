...
<div style="max-width:560px;margin:0 auto;padding:60px 16px;text-align:center;">
    ...
    <a href="{{ route('client.files.index') }}" style="background:#1e293b;color:#94a3b8;font-size:.875rem;font-weight:600;padding:10px 24px;border-radius:8px;text-decoration:none;">← Voltar aos arquivos</a>
</div>
</x-layouts.app>
