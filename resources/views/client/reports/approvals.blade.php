...
<div class="space-y-5">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-white">Aprovações</h1>
    ...
    <div class="card">
        <div class="card-header"><h3 class="font-semibold text-white text-sm">Histórico Recente</h3></div>
            ...
            <table style="width:100%;border-collapse:collapse;font-size:13px;">
                ...
                <tbody>
                    ...
                    <tr style="border-bottom:1px solid #1e293b;">
                        <td style="padding:8px 12px;color:#e2e8f0;">{{ Str::limit($a->title, 42) }}</td>
