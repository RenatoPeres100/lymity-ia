...
<div style="max-width:600px;margin:0 auto;padding:32px 16px;">
    <div style="margin-bottom:24px;">
        ...
        <h1 style="font-size:1.3rem;font-weight:700;color:#0f172a;margin:8px 0 4px;">Upload para {{ $client->name }}</h1>
    </div>
    ...
    <form method="POST" action="{{ route('admin.clients.files.store', $client) }}" enctype="multipart/form-data" style="background:#ffffff;border:1px solid #e2e8f0;border-radius:12px;padding:28px;">
        @csrf
        ...
        <div style="display:flex;gap:10px;">
            ...
            <a href="{{ route('admin.clients.files.index', $client) }}" style="background:#f1f5f9;color:#64748b;border:1px solid #e2e8f0;font-size:.875rem;font-weight:600;padding:10px 24px;border-radius:8px;text-decoration:none;">Cancelar</a>
        </div>
    </form>
</div>
</x-layouts.app>
