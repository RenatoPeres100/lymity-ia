...
<div id="scheduleModal" class="fixed inset-0 bg-black/50 z-50 hidden flex items-center justify-center">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 w-full max-w-sm mx-4">
        <h3 class="font-semibold text-gray-900 dark:text-white mb-4">Agendar Publicação</h3>
        <form id="scheduleForm" method="POST">
            ...
            <div class="flex gap-2 justify-end">
                ...
                <button type="submit" class="px-4 py-2 text-sm rounded-lg bg-purple-600 hover:bg-purple-700 text-white font-medium">
                    Agendar
                </button>
            </div>
        </form>
