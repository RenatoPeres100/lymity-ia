...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:28px;">
    <div>
        <h1 style="font-size:1.4rem;font-weight:700;color:#f1f5f9;margin-bottom:4px;">Cases</h1>
        ...
        <tbody>
            ...
            <tr style="border-bottom:1px solid #0f172a;transition:background .15s;" onmouseover="this.style.background='#0f172a'" onmouseout="this.style.background='transparent'">
                <td style="padding:14px 16px;">
                    <div style="font-size:.875rem;font-weight:600;color:#e2e8f0;margin-bottom:2px;">{{ $case->title }}</div>
                ...
                <td style="padding:14px 16px;">
                    ...
                    <span style="background:#052e16;color:#4ade80;font-size:.72rem;font-weight:600;padding:3px 10px;border-radius:20px;">Publicado</span>
                    @else
                    <span style="background:#1e293b;color:#94a3b8;font-size:.72rem;font-weight:600;padding:3px 10px;border-radius:20px;">Rascunho</span>
                    @endif
                </td>
