<x-layouts.app title="Editar Case">

<div style="margin-bottom:28px;">
    <h1 style="font-size:1.4rem;font-weight:700;color:#f1f5f9;margin-bottom:4px;">Editar Case</h1>
    <p style="font-size:.85rem;color:#64748b;"><a href="{{ route('admin.cases.index') }}" style="color:#6b8fff;text-decoration:none;">Cases</a> / Editar</p>
</div>
...
<form action="{{ route('admin.cases.update', $caseStudy) }}" method="POST">
    @csrf @method('PUT')
            ...
            <div class="table-wrapper" style="padding:24px;">
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:14px;">
                    ...
                    <div>
                        ...
                        <input type="text" name="client_name" value="{{ old('client_name', $caseStudy->client_name) }}"
                            style="width:100%;background:#0f172a;border:1px solid #1e293b;border-radius:8px;padding:10px 14px;color:#e2e8f0;font-size:.875rem;outline:none;box-sizing:border-box;"
                            onfocus="this.style.borderColor='#4a6cf7'" onblur="this.style.borderColor='#1e293b'">
                    </div>
                </div>
                <div style="margin-bottom:14px;">
                    ...
                    <textarea name="challenge" rows="3" required
                        ...
                        onfocus="this.style.borderColor='#4a6cf7'" onblur="this.style.borderColor='#1e293b'">{{ old('challenge', $caseStudy->challenge) }}</textarea>
                </div>
                <div style="margin-bottom:14px;">
                    ...
                    <textarea name="solution" rows="3"
                        style="width:100%;background:#0f172a;border:1px solid #1e293b;border-radius:8px;padding:10px 14px;color:#e2e8f0;font-size:.875rem;outline:none;resize:vertical;box-sizing:border-box;"
                        onfocus="this.style.borderColor='#4a6cf7'" onblur="this.style.borderColor='#1e293b'">{{ old('solution', $caseStudy->solution) }}</textarea>
                </div>
                <div>
                    <label style="display:block;font-size:.78rem;font-weight:600;color:#94a3b8;margin-bottom:6px;">Tags</label>
                    <input type="text" name="tags" value="{{ old('tags', is_array($caseStudy->tags) ? implode(', ', $caseStudy->tags) : $caseStudy->tags) }}"
                        style="width:100%;background:#0f172a;border:1px solid #1e293b;border-radius:8px;padding:10px 14px;color:#e2e8f0;font-size:.875rem;outline:none;box-sizing:border-box;"
                        onfocus="this.style.borderColor='#4a6cf7'" onblur="this.style.borderColor='#1e293b'">
                </div>
            </div>
            ...
            <div class="table-wrapper" style="padding:24px;">
                ...
                <div style="margin-bottom:12px;">
                    ...
                    <textarea name="testimonial" rows="3"
                        style="width:100%;background:#0f172a;border:1px solid #1e293b;border-radius:8px;padding:10px 14px;color:#e2e8f0;font-size:.875rem;outline:none;resize:vertical;box-sizing:border-box;"
                        onfocus="this.style.borderColor='#4a6cf7'" onblur="this.style.borderColor='#1e293b'">{{ old('testimonial', $caseStudy->testimonial) }}</textarea>
                </div>
                <div>
        ...
        <div style="display:flex;flex-direction:column;gap:20px;">
            <div class="table-wrapper" style="padding:24px;">
                ...
                <div>
                    ...
                    <input type="datetime-local" name="published_at" value="{{ old('published_at', $caseStudy->published_at?->format('Y-m-d\TH:i')) }}"
                        style="width:100%;background:#0f172a;border:1px solid #1e293b;border-radius:8px;padding:10px 14px;color:#e2e8f0;font-size:.875rem;outline:none;box-sizing:border-box;"
                        onfocus="this.style.borderColor='#4a6cf7'" onblur="this.style.borderColor='#1e293b'">
                </div>
            </div>
            ...
            <div class="table-wrapper" style="padding:24px;">
                <div style="font-size:.8rem;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:.06em;margin-bottom:14px;">Resultados</div>
                <textarea name="results_raw" rows="5" placeholder="Crescimento de tráfego: +320%&#10;Leads gerados: 1.240"
                    style="width:100%;background:#0f172a;border:1px solid #1e293b;border-radius:8px;padding:10px 14px;color:#e2e8f0;font-size:.8rem;outline:none;resize:vertical;box-sizing:border-box;font-family:monospace;"
                    onfocus="this.style.borderColor='#4a6cf7'" onblur="this.style.borderColor='#1e293b'">{{ old('results_raw', is_array($caseStudy->results) ? collect($caseStudy->results)->map(fn($v,$k)=>"$k: $v")->implode("\n") : '') }}</textarea>
            </div>
