<x-layouts.app>
    <div style="padding:2rem;">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:2rem;">
            <div>
                <h1 style="font-size:1.8rem;font-weight:700;color:#0f172a;">Social Media</h1>
                <p style="color:#64748b;margin-top:.25rem;">Visão geral do módulo de redes sociais</p>
            </div>
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:1rem;margin-bottom:2rem;">
            ...
            <div style="background:#ffffff;border:1px solid #e2e8f0;border-radius:.75rem;padding:1.25rem;">
                <p style="color:#64748b;font-size:.8rem;margin-bottom:.5rem;">{{ $s['label'] }}</p>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem;">
            ...
            <div style="background:#ffffff;border:1px solid #e2e8f0;border-radius:.75rem;padding:1.5rem;">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem;">
                    <h3 style="color:#0f172a;font-weight:600;">Posts Recentes</h3>
                    <a href="{{ route('admin.social.posts.index') }}" style="color:#3b82f6;font-size:.85rem;text-decoration:none;">Ver todos →</a>
                </div>
                @forelse($recentPosts as $post)
                <div style="padding:.75rem 0;border-bottom:1px solid #f1f5f9;display:flex;justify-content:space-between;align-items:center;">
                    <div>
                        <p style="color:#334155;font-size:.9rem;font-weight:500;">{{ Str::limit($post->title, 40) }}</p>
            ...
            <div style="background:#ffffff;border:1px solid #e2e8f0;border-radius:.75rem;padding:1.5rem;">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem;">
                    <h3 style="color:#0f172a;font-weight:600;">Próximos Agendamentos</h3>
        ...
        <div style="display:flex;gap:1rem;margin-top:1.5rem;flex-wrap:wrap;">
            <a href="{{ route('admin.social.channels.index') }}" style="background:#f1f5f9;border:1px solid #e2e8f0;color:#475569;padding:.75rem 1.25rem;border-radius:.5rem;text-decoration:none;font-size:.9rem;">📡 Canais</a>
            <a href="{{ route('admin.social.briefs.index') }}" style="background:#f1f5f9;border:1px solid #e2e8f0;color:#475569;padding:.75rem 1.25rem;border-radius:.5rem;text-decoration:none;font-size:.9rem;">📋 Briefs</a>
            <a href="{{ route('admin.social.calendar.index') }}" style="background:#f1f5f9;border:1px solid #e2e8f0;color:#475569;padding:.75rem 1.25rem;border-radius:.5rem;text-decoration:none;font-size:.9rem;">📅 Calendário</a>
        </div>
    </div>
</x-layouts.app>
