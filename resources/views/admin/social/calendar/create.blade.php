<x-layouts.app>
    <div style="padding:2rem;max-width:600px;">
        <div style="margin-bottom:2rem;">
            ...
            <h1 style="font-size:1.8rem;font-weight:700;color:#f1f5f9;margin-top:.5rem;">Novo Calendário</h1>
        </div>
        ...
        <form method="POST" action="{{ route('admin.social.calendar.store') }}" style="background:#1e293b;border:1px solid #334155;border-radius:.75rem;padding:2rem;">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem;margin-bottom:1.5rem;">
                <div>
                    ...
                    <select name="month" required style="width:100%;background:#0f172a;border:1px solid #334155;color:#f1f5f9;padding:.6rem .9rem;border-radius:.5rem;font-size:.9rem;">
                        @for($m=1;$m<=12;$m++)
                ...
                <div>
                    ...
                    <input type="number" name="year" value="{{ old('year', now()->year) }}" min="2024" max="2030" required style="width:100%;background:#0f172a;border:1px solid #334155;color:#f1f5f9;padding:.6rem .9rem;border-radius:.5rem;font-size:.9rem;">
                </div>
                <div>
                ...
                <div style="grid-column:1/-1;">
                    ...
                    <textarea name="strategy_summary" rows="4" style="width:100%;background:#0f172a;border:1px solid #334155;color:#f1f5f9;padding:.6rem .9rem;border-radius:.5rem;font-size:.9rem;resize:vertical;">{{ old('strategy_summary') }}</textarea>
                </div>
            </div>
            <div style="display:flex;gap:1rem;">
                ...
                <a href="{{ route('admin.social.calendar.index') }}" style="background:#334155;color:#94a3b8;padding:.7rem 1.5rem;border-radius:.5rem;text-decoration:none;font-size:.9rem;">Cancelar</a>
            </div>
        </form>
    </div>
</x-layouts.app>
