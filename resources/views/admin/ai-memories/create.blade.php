...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:28px;">
    <div>
        <h1 style="font-size:1.4rem;font-weight:700;color:#0f172a;margin-bottom:4px;">Nova Memória IA</h1>
...
<div class="table-wrapper" style="padding:28px;max-width:700px;">
    ...
    <div style="display:grid;grid-template-columns:2fr 1fr;gap:16px;margin-bottom:16px;">
        <div>
            ...
            <input type="text" name="title" value="{{ old('title') }}" required style="width:100%;background:#ffffff;border:1px solid #e2e8f0;border-radius:8px;padding:10px 12px;color:#334155;font-size:.875rem;" placeholder="Ex: Tom de voz preferido">
        </div>
        <div>
            <label style="font-size:.78rem;color:#475569;display:block;margin-bottom:6px;">Peso (1-10)</label>
            <input type="number" name="weight" value="{{ old('weight', 1) }}" min="1" max="10" style="width:100%;background:#ffffff;border:1px solid #e2e8f0;border-radius:8px;padding:10px 12px;color:#334155;font-size:.875rem;">
        </div>
    </div>
    ...
    <div>
        ...
        <textarea name="content" rows="5" required style="width:100%;background:#ffffff;border:1px solid #e2e8f0;border-radius:8px;padding:10px 12px;color:#334155;font-size:.875rem;resize:vertical;" placeholder="Descreva a memória em detalhes...">{{ old('content') }}</textarea>
    </div>
</div>
