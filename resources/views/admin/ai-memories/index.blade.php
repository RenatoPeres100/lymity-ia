...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:28px;">
    <div>
        <h1 style="font-size:1.4rem;font-weight:700;color:#f1f5f9;margin-bottom:4px;">Memórias IA</h1>
        ...
        <tbody>
            ...
            <tr style="border-bottom:1px solid #0f172a;transition:background .15s;" onmouseover="this.style.background='#0f172a'" onmouseout="this.style.background='transparent'">
                <td style="padding:12px 16px;">
                    <div style="font-size:.875rem;font-weight:600;color:#e2e8f0;">{{ $memory->title }}</div>
                ...
                <td style="padding:12px 16px;font-size:.875rem;font-weight:700;color:#e2e8f0;">{{ $memory->weight }}</td>
