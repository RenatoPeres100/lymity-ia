...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:28px;">
    <div>
        <h1 style="font-size:1.4rem;font-weight:700;color:#f1f5f9;margin-bottom:4px;">Novo Agendamento</h1>
...
<div class="table-wrapper" style="padding:28px;max-width:600px;">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px;">
        <div>
            ...
            <input type="number" name="work_minutes_per_run" value="{{ old('work_minutes_per_run', 15) }}" min="1" max="480" style="width:100%;background:#0f172a;border:1px solid #1e293b;border-radius:8px;padding:10px 12px;color:#e2e8f0;font-size:.875rem;">
        </div>
        <div>
            <label style="font-size:.78rem;color:#94a3b8;display:block;margin-bottom:6px;">Máx. tarefas por execução</label>
            <input type="number" name="max_tasks_per_run" value="{{ old('max_tasks_per_run', 3) }}" min="1" max="20" style="width:100%;background:#0f172a;border:1px solid #1e293b;border-radius:8px;padding:10px 12px;color:#e2e8f0;font-size:.875rem;">
        </div>
    </div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px;">
        ...
        <div>
            ...
            <input type="time" name="time_of_day" value="{{ old('time_of_day') }}" style="width:100%;background:#0f172a;border:1px solid #1e293b;border-radius:8px;padding:10px 12px;color:#e2e8f0;font-size:.875rem;">
        </div>
    </div>
