...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:28px;">
    <div>
        <h1 style="font-size:1.4rem;font-weight:700;color:#0f172a;margin-bottom:4px;">Lead: {{ $lead->name }}</h1>
...
<div style="display:grid;grid-template-columns:2fr 1fr;gap:24px;">
    ...
    <div style="display:flex;flex-direction:column;gap:20px;">
        <div class="table-wrapper" style="padding:28px;">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:20px;">
                ...
                <div>
                    ...
                    <div style="font-size:.9rem;color:#334155;">{{ $value }}</div>
                </div>
                @endforeach
            </div>
            ...
            <div>
                ...
                <div style="font-size:.9rem;color:#334155;">{{ str_replace('_',' ',ucfirst($lead->service_interest)) }}</div>
            </div>
            @endif
        </div>
        ...
        <div class="table-wrapper" style="padding:28px;">
            ...
            <p style="font-size:.9rem;color:#334155;line-height:1.8;white-space:pre-wrap;">{{ $lead->message }}</p>
        </div>
    </div>
    ...
    <div style="display:flex;flex-direction:column;gap:20px;">
        <div class="table-wrapper" style="padding:24px;">
            ...
            <form action="{{ route('admin.leads.update', $lead) }}" method="POST">
                @csrf @method('PUT')
                <select name="status" style="width:100%;background:#ffffff;border:1px solid #e2e8f0;border-radius:8px;padding:10px 14px;color:#334155;font-size:.875rem;outline:none;box-sizing:border-box;margin-bottom:12px;">
                ...
                <div style="margin-bottom:12px;">
                    ...
                    <textarea name="notes" rows="4"
                        style="width:100%;background:#ffffff;border:1px solid #e2e8f0;border-radius:8px;padding:10px 14px;color:#334155;font-size:.8rem;outline:none;resize:vertical;box-sizing:border-box;"
