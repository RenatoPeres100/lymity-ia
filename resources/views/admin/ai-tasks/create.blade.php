...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:28px;">
    <div>
        <h1 style="font-size:1.4rem;font-weight:700;color:#f1f5f9;margin-bottom:4px;">Nova Tarefa IA</h1>
...
<div style="display:grid;grid-template-columns:2fr 1fr;gap:24px;">
    ...
    <div class="table-wrapper" style="padding:28px;">
        <div style="font-size:.8rem;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:.06em;margin-bottom:18px;">Detalhes da Tarefa</div>
        ...
        <div style="margin-bottom:16px;">
            ...
            <input type="text" name="title" value="{{ old('title') }}" required style="width:100%;background:#0f172a;border:1px solid #1e293b;border-radius:8px;padding:10px 12px;color:#e2e8f0;font-size:.875rem;" placeholder="Descreva o objetivo da tarefa">
        </div>

        <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px;">
            <div>
                <label style="font-size:.78rem;color:#94a3b8;display:block;margin-bottom:6px;">Tipo de Tarefa</label>
                <select name="task_type" style="width:100%;background:#0f172a;border:1px solid #1e293b;border-radius:8px;padding:10px 12px;color:#e2e8f0;font-size:.875rem;">
            ...
            <div>
                <label style="font-size:.78rem;color:#94a3b8;display:block;margin-bottom:6px;">Prioridade</label>
                <select name="priority" style="width:100%;background:#0f172a;border:1px solid #1e293b;border-radius:8px;padding:10px 12px;color:#e2e8f0;font-size:.875rem;">
        ...
        <div>
            <label style="font-size:.78rem;color:#94a3b8;display:block;margin-bottom:6px;">Descrição / Instruções</label>
            <textarea name="description" rows="4" style="width:100%;background:#0f172a;border:1px solid #1e293b;border-radius:8px;padding:10px 12px;color:#e2e8f0;font-size:.875rem;resize:vertical;" placeholder="Contexto adicional para o funcionário IA...">{{ old('description') }}</textarea>
        </div>
    </div>

    <div style="display:flex;flex-direction:column;gap:20px;">
        <div class="table-wrapper" style="padding:24px;">
            <div style="font-size:.8rem;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:.06em;margin-bottom:14px;">Controles</div>
            <div style="display:flex;flex-direction:column;gap:12px;">
                <label style="display:flex;align-items:center;gap:10px;cursor:pointer;">
                    ...
                    <div>
                        <div style="font-size:.8rem;color:#e2e8f0;font-weight:600;">Requer aprovação</div>
                ...
                <label style="display:flex;align-items:center;gap:10px;cursor:pointer;">
                    ...
                    <div>
                        <div style="font-size:.8rem;color:#e2e8f0;font-weight:600;">Ação sensível</div>
...
<div style="display:flex;gap:12px;margin-top:24px;justify-content:flex-end;">
    <a href="{{ route('admin.ai-tasks.index') }}" style="background:#1e293b;color:#94a3b8;font-size:.875rem;font-weight:600;padding:10px 24px;border-radius:8px;text-decoration:none;">Cancelar</a>
