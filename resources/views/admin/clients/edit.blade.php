...
<div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;">
    ...
    <a href="{{ route('admin.clients.show', $client) }}" style="color:#64748b;text-decoration:none;font-size:.82rem;">{{ $client->name }}</a>
    <span style="color:#cbd5e1;">/</span>
    <span style="font-size:.82rem;color:#0f172a;font-weight:600;">Editar</span>
</div>
