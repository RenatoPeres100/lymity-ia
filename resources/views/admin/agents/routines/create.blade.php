<x-layouts.app title="Nova Rotina">
    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-xl font-bold text-gray-900 dark:text-white">Nova Rotina</h1>
        </div>
        ...
        <form method="POST" action="{{ route('admin.agents.routines.store') }}" class="space-y-5">
            @csrf

            @include('admin.agents.routines._form', ['routine' => null])
